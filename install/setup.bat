...
call:_colcon_prefix_chain_bat_call_script "C:\ros2\local_setup.bat"
call:_colcon_prefix_chain_bat_call_script "C:\Users\Mert\Documents\Studium\Flugrobotik\ds-crazyflies\install\local_setup.bat"
